  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-white hover:shadow-glow font-semibold border-0",
        premium: "bg-gradient-secondary text-white hover:bg-secondary-light shadow-glow font-semibold",
        locked: "bg-muted text-muted-foreground border-2 border-dashed border-muted-foreground/30 cursor-not-allowed",
        success: "bg-secondary text-secondary-foreground hover:bg-secondary-light shadow-medium",
      },
      size: {
